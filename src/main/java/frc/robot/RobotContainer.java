...
import frc.robot.commands.dropAutoCommand;
...
public class RobotContainer {
  ...
  private final Command m_shootCommand = new shootAutoCommand(DRIVE_SUBSYSTEM, LOWERJAW_SUBSYSTEM, UPPERJAW_SUBSYSTEM, PISTON_SUBSYSTEM);
  private final Command m_dropCommand = new dropAutoCommand(DRIVE_SUBSYSTEM, WINCH_SUBSYSTEM, INTAKE_SUBSYSTEM); 
  ...
  public RobotContainer() {
    ...
    m_autoChooser.setDefaultOption("shoot Auto", m_shootCommand);
    m_autoChooser.addOption("drop Auto", m_dropCommand);    
  ...
  public Command getAutonomousCommand() { 
    ...
    // private final Command m_shootCommand = new shootAutoCommand(DRIVE_SUBSYSTEM, LOWERJAW_SUBSYSTEM, UPPERJAW_SUBSYSTEM, PISTON_SUBSYSTEM);
  // private final Command m_dropCommand = new dropAutoCommand(DRIVE_SUBSYSTEM, WINCH_SUBSYSTEM, INTAKE_SUBSYSTEM); 
      // return new shootAutoCommand(DRIVE_SUBSYSTEM, LOWERJAW_SUBSYSTEM, UPPERJAW_SUBSYSTEM, PISTON_SUBSYSTEM);
      // return new dropAutoCommand(DRIVE_SUBSYSTEM, WINCH_SUBSYSTEM, INTAKE_SUBSYSTEM); 
      // return new dockingAutoCommand(DRIVE_SUBSYSTEM, LOWERJAW_SUBSYSTEM, UPPERJAW_SUBSYSTEM, PISTON_SUBSYSTEM); 
    // return new dockingAutoCommand(DRIVE_SUBSYSTEM, LOWERJAW_SUBSYSTEM, UPPERJAW_SUBSYSTEM, PISTON_SUBSYSTEM); 
  }
