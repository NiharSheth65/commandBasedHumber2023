...
public class dockingAutoCommand extends SequentialCommandGroup {
  /** Creates a new dockingAutoCommand. */
  public dockingAutoCommand(drivetrainSubsytem drive, lowerJawSubsystem lowerJaw, upperJawSubsystem upperJaw, pistonShooterSubsystem piston) {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(
        new autoDriveForwardCommand(drive, -10), 
        new upperJawCommand(upperJaw, 0, upperJawConstants.upperJawClampSpeed)
      ), 

      new dockingCommand(drive)
    );
  }
}
