...
public class pistonShooterSubsystem extends SubsystemBase {
  ...
  DoubleSolenoid pistonSolenoid = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, pistonShooterConstants.pistonforwardChannel, pistonShooterConstants.pistonreverseChannel);
