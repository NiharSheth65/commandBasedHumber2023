...
public final class Constants {
  ...
  public static final class UpperIntakeConstants{
     ...
     public static final double upperOuttakeSpeed = -0.5;
     public static final double upperIntakeDefaultSpeed = 0.1; 
  ...
  public static final class LowerJawConstants{
    ...
    public static final double lowerJawShootHighPosition = -19; 
    public static final double lowerJawShootingMidPosition = -18; 
  ...
  public static final class upperJawConstants{
    public static final double upperJawClampSpeed = 0.1; 
    public static final double upperJawReleaseSpeed = -0.1; 
