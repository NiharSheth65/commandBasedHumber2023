...
public final class Constants {
  ...
  public static final class autoConstants{
    ...
    public static final double autoConeDockingDistance = -41; 
    public static final double autoCubeCommunityClearDistance = -35; 
    public static final double autoCubeDockingDistance = -41; 
  ...
  public static final class UpperIntakeConstants{
     ...
     public static final double upperOuttakeSpeed = -0.4;
  ...
  public static final class LowerJawConstants{
    ...
    public static final double lowerJawShootHighPosition = -18.5; 
